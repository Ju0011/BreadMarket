	...
	<div class="container">
		...
		<div>
			...
			<c:choose>
				...
				<li class="nav-item"><a class="nav-link" href="<c:url value="/addBread.jsp"/>">상품 등록</a></li>
				<li class="nav-item"><a class="nav-link" href="<c:url value="/editBread.jsp?edit=update"/>">상품 수정</a></li>
				<li class="nav-item"><a class="nav-link" href="<c:url value="/editBread.jsp?edit=delete"/>">상품 삭제</a></li>
				
				<li class="nav-item"><a class="nav-link" href="<c:url value="/classes.jsp?"/>">클래스 목록</a></li>
				<li class="nav-item"><a class="nav-link" href="<c:url value="/classMenu.jsp?"/>">클래스 메뉴</a></li>
